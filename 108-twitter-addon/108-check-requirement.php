...
/**
 * Main Elementor Ideaspace Class
 *
 * The init class that runs the Elementor Ideaspace plugin.
 ...
 */
final class Elementor_108Ideaspace {
	...
	public function i18n() {
		load_plugin_textdomain( 'ideaspace-twitter-widget' );
	}
	...
	public function init() {
		...
		require_once '108-register-widget.php';
	}
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( Elementor_108Ideaspace ) );
...
// Instantiate Elementor_108Ideaspace.
new Elementor_108Ideaspace();
